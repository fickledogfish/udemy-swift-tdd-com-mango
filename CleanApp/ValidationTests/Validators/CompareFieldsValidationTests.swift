...
class CompareFieldsValidationTests: XCTestCase {
    func test_validate_should_return_error_if_comparison_fails() {
        let sut = makeSut(
            fieldName: "password",
    ...
    func test_validate_should_return_error_with_correc_field_label() {
        let sut = makeSut(
            fieldName: "password",
            fieldNameToCompare: "passwordConfirmation",
    ...
    func test_validate_should_return_nil_if_comparison_succeeds() {
        let sut = makeSut(
            fieldName: "password",
            fieldNameToCompare: "passwordConfirmation",
            fieldLabel: "Senha"
